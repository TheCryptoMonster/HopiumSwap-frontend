...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://www.hopiumswap.com/" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://www.hopiumswap.com/" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
