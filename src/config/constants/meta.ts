...
export const DEFAULT_META: PageMeta = {
  title: 'HopiumSwap',
  description:
    'The newest AMM on Polygon network! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by HopiumSwap), NFTs, and more, on a platform you can trust.',
